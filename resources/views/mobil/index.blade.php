...
<h4 class="mt-7">Data Mobil F1</h4>
        ...
        @foreach ($datas as $data)
            <tr>
                ...
                <td>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="softdeleteModal{{ $data->id_mobil }}" tabindex="-1" aria-labelledby="softdeleteModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                ...
                                <form method="POST" action="{{ route('mobil.softdelete', $data->id_mobil) }}">
                                    @csrf
                                    <div class="modal-body">
                                        Apakah anda yakin ingin menghapus data ini?
                                    </div>
